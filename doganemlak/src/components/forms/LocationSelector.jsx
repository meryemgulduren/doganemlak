      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-zinc-300 bg-zinc-100/70 text-zinc-800 text-sm font-semibold hover:bg-zinc-200/70 hover:border-zinc-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
